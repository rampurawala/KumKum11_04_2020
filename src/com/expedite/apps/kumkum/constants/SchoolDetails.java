...
public class SchoolDetails {
    ...
    public static int MAC_CLASSROOM = 56;
    public static int RPM_LIVE_CLASS = 57;
    public static final String DevelopedbyMac = "Macademic Solutions LLP.";

    //School Specific Details
    public static final String SchoolName = "KumKum";
    public static final String SchoolAddress = DevelopedbyMac;
    public static final String PhotoGalleryFolder = "KumKumPhotoGallery";
    public static final int appname = KUMKUM;
}
