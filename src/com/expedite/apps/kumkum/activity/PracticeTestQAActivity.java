...
public class PracticeTestQAActivity extends BaseActivity implements View.OnClickListener, View.OnLongClickListener {
    TextView ques, tvTestTime, correctAnsDisplay, ans_img_opt, tvRemainingCount, tvSkipCount, tvAttemptCount, tvEndTime/*, quesNo*/;
    /*RadioGroup rg_opt;*/
    String testId, quesId, correctAns, givenAns, ispeding, testName, isLast = "0", fromCompleted = "0", forExpiretestafterstart = "", testStartDate = "",testStartDate12Hour="",testEndDate12Hour="";
    DatabaseHandler db;
    ...
    Calendar calGiven, calCurrent, testStartTime;
    MenuItem refereshMenu;
    FrameLayout frame_progress;
    int selected = 0, rowTestID = 0, totalQuestion = 0;
    String testtime = "", testticksfromservice = "", teststartdatefromservice = "", extraParam = "";
    Common common;
    long millis;
    LinearLayout timeLyt, endLyt;
    RelativeLayout reviewLayout, skipLyt, queinfo;
    String currentDateandTimeTemp = "", testTicks = "", testExpireDate = "";
    public RelativeLayout rl_test;
    Common mcommon;
    List<Contact> testDetails;
    boolean skipResult = false, isfound = false, isContains = false, isDoneSkip = false;
    ...
    int after_cal;
    String correctImg = "", teststartdate = "";
    String question = "";
    //ImageView photoView;
    ImageZoom photoView;
    View mView;
   ...
   /* private Runnable mStoptest = new Runnable() {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            endLyt = findViewById(R.id.endLyt);
            ...
            Log.e("TimeZoneTimeUTC", String.valueOf(calendar.getTime()));
           ...
           /* DatabaseReference offsetRef = FirebaseDatabase.getInstance().getReference(".info/serverTimeOffset");
            ...
            //  Log.e("TimeZoneTime",calender.get(Calendar.HOUR_OF_DAY) + ":" + calender.get(Calendar.MINUTE) +  ":" + calender.getActualMinimum(Calendar.SECOND));

            showFullScreenAd(PracticeTestQAActivity.this, ActivityNames.PracticeTestQAActivity);
            Intent i = getIntent();
         ...
         /*   long tEnd = System.currentTimeMillis();
            ...
            if (ispeding.equalsIgnoreCase("0")) {
                ...
                showFullScreenAd(PracticeTestQAActivity.this, ActivityNames.PracticeTestQAActivity_Review);
                ...
                showFullScreenAd(PracticeTestQAActivity.this, ActivityNames.PracticeTestQAActivity);
                testDetails = db.getPracticeTestDetailByID(Integer.parseInt(mSchoolId), Integer.parseInt(mStudentId), Integer.parseInt(testId));

                forExpiretestafterstart = getIntent().getExtras().getString("forExpiretestafterstart", "0");
                testExpireDate = getIntent().getExtras().getString("testExpireDate", "0");
                testStartDate = getIntent().getExtras().getString("testStartDate", "0");
                testStartDate12Hour = getIntent().getExtras().getString("testStartDate12Hour", "0");
                testEndDate12Hour = getIntent().getExtras().getString("testEndDate12Hour", "0");

                if (testEndDate12Hour != null && !testEndDate12Hour.isEmpty() && !testEndDate12Hour.equalsIgnoreCase("0")) {
                    String[] splitExpireDate = testEndDate12Hour.split(" ");
                    if (splitExpireDate.length > 0) {
                        endLyt.setVisibility(View.VISIBLE);
                        tvEndTime.setText(splitExpireDate[1]+" "+splitExpireDate[2]);
                    }
                    calGiven = Calendar.getInstance();
                    calGiven.clear();
                    // SimpleDateFormat sdfGiven = new SimpleDateFormat("dd-MM-yyyy HH:mm:ss");

                    String splitDateTime[] = testExpireDate.split(" ");
          ...
          //       SkipArrays.add(listArrays.get(count));
            ...
            skip.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //commented on 06_06_2020
                    if (calCurrent != null && calGiven != null && calCurrent.getTimeInMillis() >= calGiven.getTimeInMillis()) {
                        //      showTestExpireAlert();
                        AlertDialog.Builder alertDialog = new AlertDialog.Builder(PracticeTestQAActivity.this);
                        alertDialog.setTitle(getString(R.string.title_TestExpired));
                        alertDialog.setMessage(getString(R.string.msg_TestExpired));
                    ...
                    } else if (tvTestTime.getText().equals("finish")) {
                        AlertDialog.Builder alertDialog = new AlertDialog.Builder(PracticeTestQAActivity.this);
                        ...
                        if (skip.getText().equals("Remove Selection")) {
                         ...
                         testDetails = db.getPracticeTestDetailByID(Integer.parseInt(mSchoolId), Integer.parseInt(mStudentId), Integer.parseInt(testId));
                            ...
                            AlertDialog.Builder alertDialog = new AlertDialog.Builder(PracticeTestQAActivity.this);
                            alertDialog.setTitle("Skip Alert");
                            alertDialog.setMessage(getString(R.string.msg_TestSkip, listArrays.get(count).getSixth()));
                            alertDialog.setIcon(R.drawable.information);
                            alertDialog.setCancelable(false);
                       ...
                       /* for (int i = 0; i < listArrays.size(); i++) {
                        ...
                        if (isDone == false) {*/
                           ...
                           /* for (int i = 0; i < listArrays.size(); i++) {
                            ...
                            //     showSkipAlert(listArrays.get(count).getSixth());
                            //commented on 04/06/2020
                          /*  if (skipResult == true) {
                                frame_progress.setVisibility(View.VISIBLE);
                                progressBar.setVisibility(View.VISIBLE);
                                if (SkipArrays != null && SkipArrays.size() > 0) {
...
//changed on 05_05_2020
                                    ...
                                    progressBar.setVisibility(View.GONE);
                                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(PracticeTestQAActivity.this);
                                    alertDialog.setTitle(getString(R.string.title_TestSubmit));
                                    alertDialog.setMessage(getString(R.string.msg_TestSubmit, listArrays.get(count).getSixth()));
                                    alertDialog.setIcon(R.drawable.information);
                                    alertDialog.setCancelable(false);
                                    alertDialog.setPositiveButton("Yes",
                                            new DialogInterface.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (allArrays.size() >= countAll) {
                      ...
                      /*  opt1.setText("[A] " + allArrays.get(countAll).getSeventh());
                        ...
                        opt3.setTextColor(getResources().getColor(R.color.colorPrimary));
                        opt4.setTextColor(getResources().getColor(R.color.colorPrimary));*/
                        setCorrectAns(countAll, containsImg);
                        /*String correct = "";
                        String correctImg = "";
                            ...
                            if (tmps != null && tmps.getResponse() != null && !tmps.getResponse().isEmpty()
                                ...
                                if (ispeding.equalsIgnoreCase("1")) {
                                    ...
                                    if (testDetails != null && testDetails.size() > 0) {
                                        ...
                                        //           teststartdate = testDetails.get(0).getTestStartTime();
                                    }
                                    ...
                                    /*if (testTicks == null || testTicks.isEmpty()) {
                                        ...
                                        if (testTicks == null || testTicks.isEmpty()) {
                                            ...
                                            // teststartdate = teststartdatefromservice;
                                        }
                                   ...
                                   /* String value="";
                                    if (testExpireDate != null && !testExpireDate.isEmpty() && !testExpireDate.equalsIgnoreCase("0")) {
                                        String[] splitExpireDate = testExpireDate.split(" ");

                                        if (splitExpireDate.length > 0) {
                                            value=splitExpireDate[1];
                                        }
                                    }
                                    AlertDialog.Builder alertDialog = new AlertDialog.Builder(PracticeTestQAActivity.this);
                                    alertDialog.setTitle(getString(R.string.title_testnot_started));
                                    alertDialog.setMessage(getString(R.string.msg_testnot_started,value));
                                    alertDialog.setIcon(R.drawable.information);
                                    alertDialog.setCancelable(false);
                                    alertDialog.setPositiveButton("OK",
                                            new DialogInterface.OnClickListener() {
...
/*
                               ...
                               /* opt1.setText("[A] " + allArrays.get(0).getSeventh());
                                ...
                                String value = "";
                             /*   if (testStartDate != null && !testExpireDate.isEmpty() && !testExpireDate.equalsIgnoreCase("0")) {
                                    String[] splitExpireDate = testExpireDate.split(" ");
                                ...
                                String msg_header_txt = getString(R.string.title_testnot_started);
                                String msg_txt = getString(R.string.msg_testnot_started, testStartDate12Hour);
                                Rect displayRectangle = new Rect();
                                Window window = PracticeTestQAActivity.this.getWindow();
                                window.getDecorView().getWindowVisibleDisplayFrame(displayRectangle);
                                final AlertDialog.Builder builder = new AlertDialog.Builder(PracticeTestQAActivity.this, R.style.CustomAlertDialog);
                                ViewGroup viewGroup = findViewById(android.R.id.content);
                                LayoutInflater mInflater = (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                                View dialogView = mInflater.inflate(R.layout.custom_dialog_test, viewGroup, false);
                                /* View dialogView = LayoutInflater.from(this.getContext()).inflate(R.layout.dialog_custom_layout, viewGroup, false);*/
                                ...
                                TextView msg_header = dialogView.findViewById(R.id.msg_header);
                                msg_header.setText(msg_header_txt);
                                msg.setText(msg_txt);
...
//test
                                /*AlertDialog.Builder alertDialog = new AlertDialog.Builder(PracticeTestQAActivity.this);
                                alertDialog.setTitle(getString(R.string.title_testnot_started));
                                alertDialog.setMessage(getString(R.string.msg_testnot_started,testStartDate));
                                alertDialog.setIcon(R.drawable.information);
                                alertDialog.setCancelable(false);
                                alertDialog.setPositiveButton("OK",
                                        new DialogInterface.OnClickListener() {
                                ...
                                skipLyt.setVisibility(View.GONE);
                                progressBar.setVisibility(View.GONE);
                                Constants.writelog("PracticeTestQAActivity", "getQuestion 2761:");


                               /* Toast.makeText(PracticeTestQAActivity.this, "Test not started yet!", Toast.LENGTH_SHORT).show();
                                PracticeTestQAActivity.this.finish();
                                onBackClickAnimation();*/
                            }
                        } catch (Exception ex) {
    ...
    private void setCorrectAns(int setAnsCount, boolean contains) {
        //  containsImg = false;
        containsImg = contains;
...
//                }
                ...
                Common.showToast(PracticeTestQAActivity.this, e.getMessage());
                e.printStackTrace();
            }
            return null;
        }
    ...
    public void showTestExpireAlert() {
        ...
        try {
            ...
            Constants.Logwrite("PracticeTestQAActivity", "showTestExpireAlert:" + err.getMessage()
                    + "StackTrace::" + err.getStackTrace().toString());
        }
    }

    /*public void showSkipAlert(String quesNo) {
        try {
            skipResult = false;

            AlertDialog.Builder  alertDialog= new AlertDialog.Builder(PracticeTestQAActivity.this);
            alertDialog.setTitle("Skip Alert");
            alertDialog.setMessage(getString(R.string.msg_TestSkip, quesNo));
            alertDialog.setIcon(R.drawable.information);
            alertDialog.setCancelable(false);
            alertDialog.setPositiveButton("Yes",
                    new DialogInterface.OnClickListener() {
