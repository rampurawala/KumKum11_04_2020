...
public class CurriculumClassroomActivity extends BaseActivity {
    ...
    private String SchoolId = "", ClassId = "", videoUrl = "", StudId = "", YearId = "";
    ;
    private String tag = "CurriculumClassroomActivity";
    private String mIsFromHome = "", mFolderId = "0", mFoldername = "", parentId = "", isFrom = "";
    ...
    private String mStrAudioFileName = "", mStrAudioUrl = "", title = "";
    ...
    private boolean notSelected = false, isFromBroadcast = false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_curriculum_classroom);
    ...
    public void init() {
        try {
            ...
            gotoNew = findViewById(R.id.gotoNew);
            ...
            Constants.setActionbar(getSupportActionBar(), abc, getApplicationContext(),
                    title, title, ActivityNames.CurriculumClassroomActivity);
            mAdView = (AdView) findViewById(R.id.adView);
            showBannerAd(mAdView, ActivityNames.CurriculumClassroomActivity);

            SchoolId = Datastorage.GetSchoolId(CurriculumClassroomActivity.this);
            ClassId = Datastorage.GetClassId(CurriculumClassroomActivity.this);
            StudId = Datastorage.GetStudentId(CurriculumClassroomActivity.this);
            YearId = Datastorage.GetCurrentYearId(CurriculumClassroomActivity.this);
            ...
            mFolderadapter = new CurriculumFolderAdapter(CurriculumClassroomActivity.this, mFolderArray);
            ...
            mFileadapter = new CurriculumFileAdapter(CurriculumClassroomActivity.this, mFileArray);
            mFileRecyclerview.setAdapter(mFileadapter);
            mFileRecyclerview.setNestedScrollingEnabled(false);
            gotoNew.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(CurriculumClassroomActivity.this, SubmissionFileListDiffActivity.class);
                    intent.putExtra("IsFromHome", "IsFromHome");
                    startActivity(intent);
                    common.setSession(Constants.ShowSubNew, "1");
                    CurriculumClassroomActivity.this.finish();
                    onClickAnimation();
                }
            });
                ...
                case android.R.id.home:
                    if (mFolderID.size() > 0) {
                     /*   mFolderId = mFolderID.get(mFolderID.size() - 1);
                        ...
                        super.onBackPressed();
                      /*  if(isFromBroadcast==true){
Intent i=new Intent(CurriculumClassroomActivity.this,HomeActivity.class);
...
*/
       ...
       /* } else {
            Intent intent = new Intent(CurriculumClassroomActivity.this, HomeActivity.class);
        ...
        if (isOnline()) {
            ...
            try {
                ...
                Call<CurriculumListModel> call = ((MyApplication) getApplicationContext())
                        .getmRetrofitInterfaceAppService().GetCurriculumListClassroom(SchoolId, ClassId, mFolderId, StudId, YearId, Constants.PLATFORM);
                        ...
                        try {
                            ...
                            if (tmp != null && tmp.getArray() != null && tmp.getArray().get(0).getResponse() != null
                                ...
                                if (!mFolderName.isEmpty()) {
                                    ...
                                    View customview = CurriculumClassroomActivity.this.getLayoutInflater().inflate(R.layout.mainactionbar, null);
                                    ...
                                    label1.setVisibility(View.INVISIBLE);
                                    getSupportActionBar().setCustomView(customview);
                                    //Constants.setActionbar(getSupportActionBar(), CurriculumClassroomActivity.this, getApplicationContext(), "Curriculum", "Curriculum");
                                }
                                ...
                                if (tmp != null && tmp.getArray() != null && tmp.getArray().get(0).getMessage() != null && tmp.getArray().get(0).getMessage() != "") {
                                    Common.showToast(CurriculumClassroomActivity.this, tmp.getArray().get(0).getMessage());
                                    //   onBackPressed();
                                    ...
                                    Common.showToast(CurriculumClassroomActivity.this, "No Curriculum Data Available..");
                                }
                            }
            ...
            empty_folder_lyt_file_detail.setVisibility(View.VISIBLE);
            mProgressBar.setVisibility(View.GONE);
            Common.showToast(CurriculumClassroomActivity.this, getString(R.string.msg_connection));
        }
    }
    ...
    private void ShowDialog(final String id, final String name, final String url) {
        ...
        mSendbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.isEmpty()) {
                    Common.showToast(CurriculumClassroomActivity.this, "Enter Emailid");
                } else if (!email.matches(emailPattern)) {
                    Common.showToast(CurriculumClassroomActivity.this, "Enter valid Emailid");
                ...
                call.enqueue(new Callback<SendEmailDownlodModel>() {
                    ...
                    public void onResponse(Call<SendEmailDownlodModel> call, Response<SendEmailDownlodModel> response) {
                        ...
                        if (tmps != null && tmps.getResponse() != null && !tmps.getResponse().isEmpty()
                            ...
                            if (tmps != null && tmps.getResponse() != null && !tmps.getResponse().isEmpty())
                                Common.showToast(CurriculumClassroomActivity.this, tmps.getResponse());
                        }
                    ...
                    public void onFailure(Call<SendEmailDownlodModel> call, Throwable t) {
                        Constants.writelog("CurriculumClassroomActivity",
                ...
                call.enqueue(new Callback<SendEmailDownlodModel>() {
                    ...
                    public void onResponse(Call<SendEmailDownlodModel> call, Response<SendEmailDownlodModel> response) {
                        ...
                        if (tmps != null && tmps.getResponse() != null && !tmps.getResponse().isEmpty()
                                && tmps.getResponse().equalsIgnoreCase("1")) {
                            if (tmps.getStrResult() != null && !tmps.getStrResult().isEmpty()) {
                                Common.showToast(CurriculumClassroomActivity.this, tmps.getStrResult());
                                if (alert.isShowing())
                                    alert.dismiss();
                            }
                        } else {
    ...
    private class CurriculumFileAdapter extends RecyclerView.Adapter<CurriculumFileAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            try {
                ...
                if (tmp.getInstructions() != null && !tmp.getInstructions().isEmpty()) {
                    holder.txtInstruction.setVisibility(View.VISIBLE);
                    holder.divider.setVisibility(View.VISIBLE);
                    holder.txtInstruction.setText(Html.fromHtml("Instruction : <B>" + tmp.getInstructions() + "</B>"));
                } else {
                ...
                if (tmp.getDueDate() != null && !tmp.getDueDate().isEmpty()) {
                    ...
                    holder.divider.setVisibility(View.VISIBLE);
                    holder.txtduedate.setText(Html.fromHtml("Due Date : <B>" + tmp.getDueDate() + "</B>"));
                } else {
               ...
               /* mCheckBoxSelectAll.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                holder.mImgComplete.setVisibility(View.VISIBLE);
                ...
                if (tmp.getType() != null && !tmp.getType().isEmpty()) {
                    if (tmp.getType().equals("1")) {
                        ...
                        holder.mImgEmail.setVisibility(View.GONE);
                        holder.mCheckBox.setVisibility(View.VISIBLE);
                        holder.mImgShare.setVisibility(View.VISIBLE);
                ...
                holder.mImgDownload.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            ...
                            if (ContextCompat.checkSelfPermission(CurriculumClassroomActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                                ...
                                if (tmp.getType().equals("3")) {
                                    ...
                                    DownloadPdfOrImageFile(CurriculumClassroomActivity.this, tmp.getName(),
                                            tmp.getUrl());
                                } else if (tmp.getType().equals("4")) {
                ...
                holder.mImgComplete.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        try {
                            Intent intent = new Intent(CurriculumClassroomActivity.this, CurriculumResponseClassroomActivity.class);
                ...
                holder.mBtnShare.setVisibility(View.GONE);
                holder.mImgShare.setVisibility(View.VISIBLE);
                            ...
                            for (int i = 0; i < mFileArray.size(); i++) {
                                if (mFileArray.get(i).getIsChecked() != null && mFileArray.get(i).getIsChecked().equalsIgnoreCase("1")) {
                                    ...
                                    if (mFileArray.get(i).getType().equals("3")) {
                                        ...
                                        DownloadPdfOrImageFile(CurriculumClassroomActivity.this, mFileArray.get(i).getName(),
                    ...
                    public void onClick(View view) {
                        if (tmp.getType() != null && !tmp.getType().isEmpty()) {
                            ...
                            if (tmp.getType().equalsIgnoreCase("1")) {
                                if (tmp.getUrl() != null &&
                                        !tmp.getUrl().isEmpty()) {
                                    Intent intent = new Intent(CurriculumClassroomActivity.this, CurriculumPdfViewActivity.class);
                                ...
                                if (tmp.getUrl() != null &&
                                        !tmp.getUrl().isEmpty()) {
                                    Intent intent = new Intent(CurriculumClassroomActivity.this, CurriculumImageViewActivity.class);
                                    intent.putExtra("Id", tmp.getId());
                                    intent.putExtra("Name", tmp.getName());
                                    intent.putExtra("Url", tmp.getUrl());
                                    intent.putExtra("HeaderText", headerText);
                                ...
                                if (tmp.getUrl() != null &&
                                        !tmp.getUrl().isEmpty()) {
                                    Intent intent = new Intent(CurriculumClassroomActivity.this, CurriculumMediaPlayerActivity.class);
                                    intent.putExtra("Id", tmp.getId());
                                    intent.putExtra("Name", tmp.getName());
                                    intent.putExtra("Url", tmp.getUrl());
                                    intent.putExtra("HeaderText", headerText);
                                ...
                                if (tmp.getUrl() != null &&
                                    ...
                                    if (vidoeId != null && !vidoeId.isEmpty()) {
                                        Intent intent = new Intent(CurriculumClassroomActivity.this, YouTubePlayerActivity.class);
                            ...
                            if (tmp.getType().equalsIgnoreCase("5")) {
                                if (tmp.getUrl() != null &&
                                        !tmp.getUrl().isEmpty()) {
                                    Intent intent = new Intent(CurriculumClassroomActivity.this, CurriculumTextFileActivity.class);
                                    intent.putExtra("Id", tmp.getId());
                                    intent.putExtra("Name", tmp.getName());
                                    intent.putExtra("Url", tmp.getUrl());
                                    intent.putExtra("HeaderText", headerText);
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            //  MaterialButton mImgDownload, mImgComplete, mBtnShare;
            RelativeLayout mImgDownload, mImgComplete, mBtnShare;
        ...
        try {
            if (Build.VERSION.SDK_INT >= 23) {
                ...
                if (i == 2) {
                    ...
                    ActivityCompat.requestPermissions(CurriculumClassroomActivity.this, perm, 1);
                }
        ...
        switch (requestCode) {
            ...
            case 2:
                if (grantResults[1] == PackageManager.PERMISSION_GRANTED) {
                    Toast.makeText(CurriculumClassroomActivity.this, "Permission given Now you can download the files...", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(CurriculumClassroomActivity.this, "Permission Denied", Toast.LENGTH_SHORT).show();
                }
                break;
        }
    }
  ...
  /*  public void saveAudio() {
    ...
    public class SaveAudioTask extends AsyncTask<String, String, Void> {
        ...
        protected void onPreExecute() {
            try {
                // mProgressbar.setVisibility(View.VISIBLE);
                mAudioProgressDialog = new ProgressDialog(CurriculumClassroomActivity.this);
...
//                }
                ...
                Common.showToast(CurriculumClassroomActivity.this, e.getMessage());
                e.printStackTrace();
            }
            return null;
        }
        ...
        protected void onPostExecute(Void result) {
            ...
            Common.showToast(CurriculumClassroomActivity.this, "File Downloaded.");
