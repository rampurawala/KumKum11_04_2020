...
import static com.expedite.apps.kumkum.activity.SubmissionFileListDiffActivity.mSubmittedArrayList;

public class SubmissionSubmittedFragment extends Fragment {
    private View mParentView;
    private ProgressBar mProgressbar;
    private RecyclerView mSubmissionFileRV;
    public static SubmissionFileListAdapter mLeaveAdapterSubmitted;
    private LinearLayout mLLShareDownloadAll;
    AppCompatButton mBtnDownload, mBtnShare;

    private String mUserId = "", mGroupId = "";

    public static final SubmissionSubmittedFragment newInstance(String paramString) {
        SubmissionSubmittedFragment f = new SubmissionSubmittedFragment();
    ...
    private void init() {
        try {
            ...
            mLeaveAdapterSubmitted = new SubmissionFileListAdapter(getActivity(), mSubmittedArrayList,mBtnDownload,mBtnShare,mLLShareDownloadAll);
            mSubmissionFileRV.setAdapter(mLeaveAdapterSubmitted);
